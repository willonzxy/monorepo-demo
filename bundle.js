var Test = (function (exports) {
  ...
  var uncurryThis$g = NATIVE_BIND$2 && bind$6.bind(call$e, call$e);
  ...
  var getBuiltIn$9 = function (namespace, method) {
    return arguments.length < 2
      ? aFunction(path$2[namespace]) || aFunction(global$i[namespace])
  ...
  var ordinaryToPrimitive$1 = function (input, pref) {
    ...
    if (
      pref === "string" &&
      isCallable$d((fn = input.toString)) &&
      !isObject$7((val = call$c(fn, input)))
    )
      return val;
    if (
      isCallable$d((fn = input.valueOf)) &&
      !isObject$7((val = call$c(fn, input)))
    )
      return val;
    if (
  ...
  objectGetOwnPropertyDescriptor.f = DESCRIPTORS$6
    ...
    : function getOwnPropertyDescriptor(O, P) {
        ...
        if (hasOwn$8(O, P))
          return createPropertyDescriptor$4(
            !call$a(propertyIsEnumerableModule.f, O, P),
            O[P]
          );
      };
  ...
  var createNonEnumerableProperty$7 = DESCRIPTORS$3
  ...
  var _export = function (options, source) {
    ...
    var nativeSource = GLOBAL
      ...
      : STATIC
      ? global$c[TARGET]
      : (global$c[TARGET] || {}).prototype;

    var target = GLOBAL
      ? path$1
      : path$1[TARGET] ||
        createNonEnumerableProperty$6(path$1, TARGET, {})[TARGET];
    ...
    for (key in source) {
      ...
      if (options.bind && USE_NATIVE)
        resultProperty = bind$4(sourceProperty, global$c);
      // wrap global constructors for prevent changs in this version
      else if (options.wrap && USE_NATIVE)
        resultProperty = wrapConstructor(sourceProperty);
      // make static versions for prototype methods
      else if (PROTO && isCallable$b(sourceProperty))
      ...
      if (PROTO) {
        ...
        if (!hasOwn$7(path$1, VIRTUAL_PROTOTYPE)) {
          createNonEnumerableProperty$6(path$1, VIRTUAL_PROTOTYPE, {});
        }
  ...
  var objectKeysInternal = function (object, names) {
    ...
    var key;
    for (key in O)
      !hasOwn$5(hiddenKeys$3, key) && hasOwn$5(O, key) && push$1(result, key);
  ...
  var isArrayIteratorMethod$1 = function (it) {
    return (
      it !== undefined &&
      (Iterators$5.Array === it || ArrayPrototype[ITERATOR$4] === it)
    );
  };
  ...
  var engineIsIosPebble =
    /ipad|iphone|ipod/i.test(userAgent$1) && global$7.Pebble !== undefined;
  ...
  var NATIVE_PROMISE_REJECTION_EVENT$1 = isCallable$2(
    global$3.PromiseRejectionEvent
  );

  var FORCED_PROMISE_CONSTRUCTOR$5 = isForced("Promise", function () {
    var PROMISE_CONSTRUCTOR_SOURCE = inspectSource(NativePromiseConstructor$5);
    var GLOBAL_CORE_JS_PROMISE =
      PROMISE_CONSTRUCTOR_SOURCE !== String(NativePromiseConstructor$5);
      ...
      race: function race(iterable) {
        ...
        var result = perform$3(function () {
          ...
          iterate$2(iterable, function (promise) {
            call$3($promiseResolve, C, promise).then(
              capability.resolve,
              reject
            );
          });
